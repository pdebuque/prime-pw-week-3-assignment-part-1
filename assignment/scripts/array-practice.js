...
console.log('1b. Some of my favorite foods are:', favFoodArray);
...
console.log(`3c. Last animal is ${animalArray[animalArray.length - 1]}`);
...
console.log(`4b. Removed the last food, ${removedFood}`);
...
console.log(`4d. Removed the first food, ${removedFood}`);
console.log('The foods are now', favFoodArray);
...
console.log(favFoodArray.splice(1, 1, 'paella'))
